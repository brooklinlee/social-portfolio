// images
// headers
import PLMHeader from '../../assets/images/PLM/PLMHeader.svg'
import iTOVIHeader from '../../assets/images/iTOVi/iTOViHeader.svg'
import BRHeader from '../../assets/images/BR/BRHeader.svg'
import OliveHeader from '../../assets/images/Olive/OliveHeader.svg'
import OilStuffHeader from '../../assets/images/OilStuff/OilStuffHeader.svg'
import ZivaHeader from '../../assets/images/Ziva/ZivaHeader.svg'

// Pür Life
import PLMSqr1 from '../../assets/images/PLM/PLMSqr1.svg'
import PLMSqr2 from '../../assets/images/PLM/PLMSqr2.svg'
import PLMCarousel1A from '../../assets/images/PLM/PLMCarousel1A.svg'
import PLMCarousel1B from '../../assets/images/PLM/PLMCarousel1B.svg'
import PLMPortrait1 from '../../assets/images/PLM/PLMPortrait1.svg'
import PLMPortrait2 from '../../assets/images/PLM/PLMPortrait2.svg'

// iTOVi
import iTOViSqr1 from '../../assets/images/iTOVi/iTOViSqr1.svg'
import iTOViSqr2 from '../../assets/images/iTOVi/iTOViSqr2.svg'
import iTOViSqr3 from '../../assets/images/iTOVi/iTOViSqr3.svg'
import iTOViSqr4 from '../../assets/images/iTOVi/iTOViSqr4.svg'
import iTOViSqr5 from '../../assets/images/iTOVi/iTOViSqr5.svg'
import iTOViSqr6 from '../../assets/images/iTOVi/iTOViSqr6.svg'
import iTOViSqr7 from '../../assets/images/iTOVi/iTOViSqr7.svg'
import iTOViSqr8 from '../../assets/images/iTOVi/iTOViSqr8.svg'
import iTOViSqr9 from '../../assets/images/iTOVi/iTOViSqr9.svg'
import iTOViSqr10 from '../../assets/images/iTOVi/iTOViSqr10.svg'
import iTOViSqr11 from '../../assets/images/iTOVi/iTOViSqr11.svg'
import iTOViCarousel1A from '../../assets/images/iTOVi/iTOViCarousel1A.svg'
import iTOViCarousel1B from '../../assets/images/iTOVi/iTOViCarousel1B.svg'
import iTOViCarousel1C from '../../assets/images/iTOVi/iTOViCarousel1C.svg'
import iTOViCarousel2A from '../../assets/images/iTOVi/iTOViCarousel2A.svg'
import iTOViCarousel2B from '../../assets/images/iTOVi/iTOViCarousel2B.svg'
import iTOViCarousel2C from '../../assets/images/iTOVi/iTOViCarousel2C.svg'
import iTOViCarousel2D from '../../assets/images/iTOVi/iTOViCarousel2D.svg'
import iTOViCarousel3A from '../../assets/images/iTOVi/iTOViCarousel3A.svg'
import iTOViCarousel3B from '../../assets/images/iTOVi/iTOViCarousel3B.svg'
import iTOViCarousel3C from '../../assets/images/iTOVi/iTOViCarousel3C.svg'
import iTOViCarousel3D from '../../assets/images/iTOVi/iTOViCarousel3D.svg'
import iTOViCarousel3E from '../../assets/images/iTOVi/iTOViCarousel3E.svg'

// Black Rock
import BRLS1 from '../../assets/images/BR/BRLS1.svg'
import BRLS2 from '../../assets/images/BR/BRLS2.svg'
import BRCarousel1A from '../../assets/images/BR/BRCarousel1A.svg'
import BRCarousel1B from '../../assets/images/BR/BRCarousel1B.svg'
import BRCarousel2A from '../../assets/images/BR/BRCarousel2A.svg'
import BRCarousel2B from '../../assets/images/BR/BRCarousel2B.svg'
import BRCarousel3A from '../../assets/images/BR/BRCarousel3A.svg'
import BRCarousel3B from '../../assets/images/BR/BRCarousel3B.svg'
import BRCarousel3C from '../../assets/images/BR/BRCarousel3C.svg'
import BRCarousel3D from '../../assets/images/BR/BRCarousel3D.svg'

// Olive
import OliveSqr1 from '../../assets/images/Olive/OliveSqr1.svg'
import OlivePortrait1 from '../../assets/images/Olive/OlivePortrait1.svg'
import OlivePortrait2 from '../../assets/images/Olive/OlivePortrait2.svg'
import OlivePortrait3 from '../../assets/images/Olive/OlivePortrait3.svg'
import OlivePortrait4 from '../../assets/images/Olive/OlivePortrait4.svg'
import OliveCarousel1A from '../../assets/images/Olive/OliveCarousel1A.svg'
import OliveCarousel1B from '../../assets/images/Olive/OliveCarousel1B.svg'

// Oil Stuff
import OilStuffSqr1 from '../../assets/images/OilStuff/OilStuffSqr1.svg'
import OilStuffSqr2 from '../../assets/images/OilStuff/OilStuffSqr2.svg'
import OilStuffSqr3 from '../../assets/images/OilStuff/OilStuffSqr3.svg'
import OilStuffSqr4 from '../../assets/images/OilStuff/OilStuffSqr4.svg'
import OilStuffSqr5 from '../../assets/images/OilStuff/OilStuffSqr5.svg'
import OilStuffSqr6 from '../../assets/images/OilStuff/OilStuffSqr6.svg'
import OilStuffSqr7 from '../../assets/images/OilStuff/OilStuffSqr7.svg'
import OilStuffSqr8 from '../../assets/images/OilStuff/OilStuffSqr8.svg'
import OilStuffSqr9 from '../../assets/images/OilStuff/OilStuffSqr9.svg'
import OilStuffSqr10 from '../../assets/images/OilStuff/OilStuffSqr10.svg'
import OilStuffSqr11 from '../../assets/images/OilStuff/OilStuffSqr11.svg'
import OilStuffSqr12 from '../../assets/images/OilStuff/OilStuffSqr12.svg'

// Ziva
import ZivaSqr1 from '../../assets/images/Ziva/ZivaSqr1.svg'
import ZivaSqr2 from '../../assets/images/Ziva/ZivaSqr2.svg'
import ZivaSqr3 from '../../assets/images/Ziva/ZivaSqr3.svg'
import ZivaSqr4 from '../../assets/images/Ziva/ZivaSqr4.svg'
import ZivaSqr5 from '../../assets/images/Ziva/ZivaSqr5.svg'
import ZivaSqr6 from '../../assets/images/Ziva/ZivaSqr6.svg'
import ZivaSqr7 from '../../assets/images/Ziva/ZivaSqr7.svg'
import ZivaSqr8 from '../../assets/images/Ziva/ZivaSqr8.svg'
import ZivaSqr9 from '../../assets/images/Ziva/ZivaSqr9.svg'
...
const brands = [
  {
    ...
    pDescriptorOne: <p>Pür Life Medical is a medical clinic in Cottonwood Heights, Utah, specializing in holistic healthcare. As their dedicated social media manager, I oversee all aspects of their online presence. Additionally, I crafted their entire website on WordPress, leveraging skills in WordPress, Elementor, and HostGator. From services pages to event promotion, I handle all aspects of website management and content creation. On social media, my role involves developing and executing comprehensive content strategies across Facebook, Instagram, and YouTube. This includes all copy and videos, photos, and graphics.</p>,
    ...
    pDescriptorTwo: <p>Check out some of the content that I have created for them down below, or click <a href='https://purlifecottonwood.com/'>here</a> to view their website!</p>,
    videos: [
      {
        src: PLMReel1,
  ...
  },
  {
    ...
    pDescriptorOne: <p>iTOVi offers a handheld scanner device that suggests essential oils based on individual wellness needs. During my time there from September 2019 to October 2021, I managed their social media presence and content creation. I developed and oversaw content strategies for iTOVi and associated brands, such as Ziva Medical, Oil Stuff, and Eighty8 Keys, across multiple social media platforms. Additionally, I coordinated online events, webinars, and giveaways to foster organic growth and engagement within the user community.</p>,
    liOne: <><li>Developed and oversaw content strategies for iTOVi and associated brands.</li><li>Coordinated online events and webinars to engage the user community.</li><li>Oversaw the iTOVi Influencer Program for onboarding and management</li></>,
    liTwo:<><li>Managed social media content creation across various platforms.</li><li>Collaborated with influencers and industry experts to amplify brand visibility and reach a wider audience.</li><li>Implemented data-driven insights to refine content strategies and optimize engagement across all social media platforms.</li></>,
    pDescriptorTwo: <p>Check out some of the content that I created for iTOVi down below!</p>,
    images: [
      {
        src: iTOViSqr1,
  ...
  },
  {
    ...
    pDescriptorOne: <p>Black Rock Mountain Resort offers luxury condos and townhomes near Park City, Utah. I had them as a social media client from November 2022 to August 2023, and during that time I strategically developed and managed their Instagram and Facebook content creation. I worked with Black Rock to both visit their condos and townhomes on a weekly basis to create content, as well as pull from a library of available resources and assets to enhance the resort's online presence and attract potential guests and buyers alike.</p>,
    liOne: <><li>Strategically developed and managed Instagram and Facebook content.</li><li>Collaborated with the marketing team to align social media content with overall branding and promotional campaigns, ensuring consistency and coherence across all channels.</li></>,
    liTwo:<><li>Conducted regular performance analyses and implemented optimizations to improve content effectiveness and audience engagement metrics.</li><li>Curated engaging content to enhance online presence.</li></>,
    pDescriptorTwo: <p>Check out some of the content that I created for Black Rock Mountain Resort below!</p>,
    images: [
      {
        src: BRLS1,
  ...
  },
  {
    ...
    description: 'Dog Grooming Pet Salon',
    pDescriptorOne: <p>Olive Dog Salons is a dog grooming salon that I previously owned. During my time owning it I oversaw all operations, developed a streamlined system to serve a large client base, and found nnovative ways to foster brand loyalty. Additionally, I managed a team of six employees and optimized our digital presence across Instagram and Facebook, resulting in sustained growth and a loyal customer base.</p>,
    liOne: <><li>Established and implemented standardized grooming protocols to ensure consistent quality service delivery and customer satisfaction.</li><li>Spearheaded social media campaigns and presence to reach our target audience and get new clients</li></>,
    liTwo:<><li>Hired and managed a team of six full-time employees.</li><li>Designed and produced all advertizing materials and website assets.</li></>,
    pDescriptorTwo: <p>Check out some of the content that I created for Olive Dog Salons below!</p>,
    images: [
      {
        src: OlivePortrait1,
  ...
  }, 
  {
    ...
    name: 'Oil Stuff',
    description: 'Online Essential Oils Accessories & Educational Content Store',
    pDescriptorOne: <p>Oil Stuff is a subsidiary brand of iTOVi that specializes in essential oil accessories. The owners of iTOVi created this brand to expand their ability to sell accessories in an industry that they were already familiar with, and I ran this account congruently with iTOVi.</p>,
    liOne: <><li>Developed and executed comprehensive social media content strategies.</li></>,
    liTwo:<><li>Created engaging visuals and compelling copy.</li></>,
    pDescriptorTwo: <p>Check out some of the content that I created for Oil Stuff here!</p>,
    images: [
      {
        src: OilStuffSqr1,
  ...
  },
  {
    ...
    pDescriptorOne: <p>Ziva, another subsidiary brand of iTOVi, focused on women's health services. As the social media manager for this brand, I developed and executed social media content strategies across Facebook and Instagram while congruently running the iTOVi and Oil Stuff Accounts. This was a brick and mortar store, and I ran the social media for this account before they had officially opened at all, limiting my content to general posts about pain points that the service they were to provide in the future and how they could solve them. </p>,
    liOne: <><li>Developed and executed comprehensive social media content strategies.</li></>,
    liTwo:<><li>Created engaging content and visuals to promote women's health services.c</li></>,
    pDescriptorTwo: <p>Check out some of the content that I created for Ziva down below!</p>,
    images: [
      {
        src: ZivaSqr1,
